        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          <div className="text-center lg:text-left">
            ...
            <h1 className="font-serif text-[#003b27] text-[34px] sm:text-[44px] md:text-[52px] lg:text-[54px] leading-[1.1] tracking-[-0.03em]">
              Senior Mental Health Needs
              <br />
              <span className="text-[#e0aa3e]">Gentle, Root-Cause Care</span>
            </h1>

            <p className="mt-5 text-[16px] sm:text-[18px] text-[#2f3f4a] leading-[1.7] max-w-[600px] mx-auto lg:mx-0">
              Memory decline, sleep disturbance, anxiety, and brain fog should
              not be ignored as
              <span className="font-semibold"> “normal aging.”</span> They
              deserve attention — gently and intelligently.
            </p>
            ...
            {[
              {
                ...
                desc: "Memory, clarity & mental sharpness support",
              },
              {
                icon: HeartPulse,
                title: "Emotional Well-being",
                desc: "Anxiety, mood & emotional balance",
              },
              {
                icon: Activity,
                title: "Nervous System",
                desc: "Calmness, stability & stress response",
              },
              {
                icon: Moon,
                title: "Sleep & Recovery",
                desc: "Restful sleep & daily energy support",
              },
            ].map((item, index) => {
