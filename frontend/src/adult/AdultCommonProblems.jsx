...
export default function AdultCommonProblems() {
  return (
    <section className="w-full bg-[#fbfaf7] px-4 sm:px-10 lg:px-8 py-5 sm:py-">
      <div className=" mx-auto">
        ...
        <h2 className="font-serif text-[#073821] text-[26px] sm:text-[34px] md:text-[40px] lg:text-[42px] leading-[1.15] tracking-[-0.03em] max-w-[900px]">
          What Many Adults Quietly Struggle With
        </h2>

        {/* Pills */}
        <div className="mt-8 flex flex-wrap gap-x-2 gap-y-2 max-w-[1000px]">
          {problems.map((item, index) => (
            <span
              key={index}
